...
export function MobileWelcomeScreen({ onDismiss }: MobileWelcomeScreenProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex flex-col md:hidden overflow-hidden" style={{ background: '#f0f7f0' }}>
      ...
      <div className="px-7 pt-12 pb-4 shrink-0">
        ...
        {/* Título */}
        <div className="mb-3">
          <h1 className="text-4xl font-black leading-tight tracking-tight" style={{ color: '#1a3d1a' }}>
            Reserva<br />
            <span style={{ color: '#2d7a2d' }}>tu cancha</span><br />
            de forma fácil<br />
            y rápida
          </h1>
        </div>
        ...
        <p className="text-base leading-relaxed" style={{ color: '#6b7280' }}>
          Encuentra y reserva canchas<br />deportivas cerca de ti.
        </p>
      </div>
      ...
      {/* Botones inferiores */}
      <div className="px-6 pb-10 pt-4 flex flex-col gap-3 shrink-0" style={{ background: '#f0f7f0' }}>
        <button
          onClick={handleLogin}
        ...
        <button
          ...
          style={{ borderColor: '#e0e0e0', color: '#1a3d1a', background: 'white' }}
        >
          Crear cuenta
        </button>
